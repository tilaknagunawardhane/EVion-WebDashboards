...
export default function ChargingStationsTopBar({ search, setSearch, filter, setFilter, sort, setSort }) {
  const [showFilter, setShowFilter] = useState(false);
  const [showSort, setShowSort] = useState(false);

  const filterOptions = [
    { label: 'District City', value: 'districtCity' },
    { label: 'Booking System', value: 'bookingSystem' },
              ...
              {filterOptions.map(opt => (
                <button
                  ...
                  style={{
                    ...
                    // ':hover': {
                    //   backgroundColor: COLORS.bgGreen, // Use your custom color
                    // }
                  }}
                  onClick={() => {
                    setFilter(opt);
