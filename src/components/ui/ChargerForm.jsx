      ...
      <div className="flex-1 overflow-y-auto pb-4">
        ...
        <div className="space-y-6">
          ...
          {chargers.map((charger, index) => {
            ...
            const editable = isChargerEditable(charger);
            return(
              <div key={index} className="p-4 rounded-lg" style={{ backgroundColor: COLORS.background }}>
                ...
                {!editable && (
                  <div className="mb-3 p-2 bg-yellow-50 text-yellow-800 rounded text-sm">
                    This charger cannot be edited because its status is "{charger.status}".
                  </div>
                )}
